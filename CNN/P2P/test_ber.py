...
if __name__ == "__main__":
    ...
    ckpt_path = r"F:\LJN\bishe\bishe\CNN\RESNET_rayleigh_all_h\results\best_resnet_model.pth"
    baseline_csv_path = r"F:\LJN\bishe\bishe\CNN\RESNET_rayleigh_all_h\ber_result\baseline_ber.csv"
    result_save_path = r"F:\LJN\bishe\bishe\CNN\RESNET_rayleigh_all_h\ber_result\ber_curve_resnet.png"
    ...
    for snr_db in snr_range:
        ...
        ebn0_db = snr_db - 10 * math.log(16, 10)

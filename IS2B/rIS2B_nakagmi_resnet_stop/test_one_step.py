...
if __name__ == "__main__":
    ...
    ckpt_path = fr'IS2B/rIS2B_nakagmi_resnet_stop/results/best_model_IS2B_resnet_{n_steps}.pth'
    
    # 结果保存
    result_img_path = f'IS2B/rIS2B_nakagmi_resnet_stop/ber_results/ber_curve_onestep_resnet.png'
    result_csv_path = f'IS2B/rIS2B_nakagmi_resnet_stop/ber_results/ber_data_onestep_resnet.csv'
    
    # 基准 BER 文件 (可选)
    baseline_csv_path = 'IS2B/rIS2B_nakagmi_resnet_stop/ber_results/baseline_ber.csv'
    ...
    # ----- 3. 运行测试 -----
    snr_range = np.arange(2, 19, 1) # 2dB 到 18dB
    model_bers = []

...
if __name__ == "__main__":
    ...
    # 结果保存
    result_img_path = f'IS2B/rIS2B_rayleigh_all_h_resnet_cfg/ber_results/ber_curve_onestep_resnet.png'
    result_csv_path = f'IS2B/rIS2B_rayleigh_all_h_resnet_cfg/ber_results/ber_data_onestep_resnet.csv'
    
    # 基准 BER 文件 (可选)
    baseline_csv_path = 'IS2B/rIS2B_rayleigh_all_h_resnet_cfg/ber_results/baseline_ber.csv'

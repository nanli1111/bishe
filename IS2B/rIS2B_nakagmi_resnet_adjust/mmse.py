...
def plot_constellation(symbols_complex, snr_db, save_dir, num_points=2048):
    ...
    # 画标准参考点 (QPSK: ±0.707 ± 0.707j)
    ref_pts = [0.707+0.707j, -0.707+0.707j, -0.707-0.707j, 0.707-0.707j]
...
if __name__ == "__main__":
    ...
    vis_dir = os.path.join("F:\LJN\bishe\bishe\IS2B\rIS2B_nakagmi_resnet_adjust\vis_constellations", 'baseline')
    ...
    for snr in tqdm(snr_range):
        ...
        ber = run_simulation(
            ...
            snr_db=snr, 
            rrc_filter=rrc,
            vis_indices=None, # 这次不画波形了，专注星座图
            save_dir=save_dir,

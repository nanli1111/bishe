...
if __name__ == "__main__":
    ...
    checkpoint_path = r"F:\LJN\bishe\bishe\CNN\RESNET_rayleigh_all_h\results\best_resnet_model.pth"
    save_dir = r"F:\LJN\bishe\bishe\CNN\RESNET_rayleigh_all_h\results"

    # 1. 准备数据集（参照你给的模板）
    train_data = QPSKDataset(0, 400000)

    # 2. 对 y_impaired 加噪声，SNR = 10 - 10 * log_10(16)
    snr_db = 10 - 10 * math.log(16, 10)   # 这里用 math.log(x, 10) 明确以 10 为底

...
if __name__ == "__main__":
    ...
    guidance_scale = 1.5 # 如果没用 CFG 训练，保持 1.0
    ...
    # 结果保存路径
    result_save_path = f'IS2B/rIS2B_rayleigh_all_h_resnet_cfg/ber_results/ber_curve_resnet.png'
    result_csv_path = f'IS2B/rIS2B_rayleigh_all_h_resnet_cfg/ber_results/ber_data_resnet.csv'

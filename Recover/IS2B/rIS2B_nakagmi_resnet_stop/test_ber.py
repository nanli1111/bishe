    ...
    with torch.no_grad():
        for start in tqdm(range(0, n, batch_size), desc=f"SNR(sample)={snr_db_sample:.2f} dB"):
            ...
            x_rec = is2b_instance.sample(
                ...
                stop_t=0.8  # <--- 新增参数，尝试 0.05, 0.1, 0.2
            )
...
if __name__ == "__main__":
    ...
    # 结果保存路径
    result_save_path = f'IS2B/rIS2B_nakagmi_resnet_stop/ber_results/ber_curve_resnet.png'
    result_csv_path = f'IS2B/rIS2B_nakagmi_resnet_stop/ber_results/ber_data_resnet.csv'

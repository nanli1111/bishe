...
if __name__ == "__main__":
    ...
    # 结果保存
    result_img_path = f'IS2B/rIS2B_rayleigh_all_h_resnet_stop/ber_results/ber_curve_onestep_resnet.png'
    result_csv_path = f'IS2B/rIS2B_rayleigh_all_h_resnet_stop/ber_results/ber_data_onestep_resnet.csv'

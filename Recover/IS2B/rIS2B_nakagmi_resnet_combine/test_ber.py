...
if __name__ == "__main__":
    ...
    # 保存路径 (文件名改一下以区分)
    result_save_path = f'IS2B/rIS2B_nakagmi_resnet_combine/ber_results/ber_curve_resnet_hybrid.png'
    result_csv_path = f'IS2B/rIS2B_nakagmi_resnet_combine/ber_results/ber_data_resnet_hybrid.csv'
    
    baseline_csv_path = 'IS2B/rIS2B_nakagmi_resnet_combine/ber_results/ber_curve_resnet_values.csv'

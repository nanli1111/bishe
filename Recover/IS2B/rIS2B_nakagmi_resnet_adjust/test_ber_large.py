...
if __name__ == "__main__":
    ...
    # === 路径配置 ===
    ckpt_path = fr'IS2B/rIS2B_nakagmi_resnet_adjust/results/best_model_IS2B_resnet_pro_scope_andlarge_{n_steps}.pth'
    
    # 保存路径 (文件名改一下以区分)
    result_save_path = f'IS2B/rIS2B_nakagmi_resnet_adjust/ber_results/ber_curve_resnet_scope_large.png'
    result_csv_path = f'IS2B/rIS2B_nakagmi_resnet_adjust/ber_results/ber_data_resnet_scope_large.csv'

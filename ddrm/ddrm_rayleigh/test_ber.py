...
if __name__ == "__main__":
    ...
    ckpt_path = fr'ddrm/ddrm_rayleigh/results/best_model_epoch_with_n_steps{n_steps}.pth'
    ...
    plot_ber(
        ...
        ref_bers,
        snr_range,
        save_path=f'ddrm/ddrm_rayleigh/ber_result/ber_curve_nsteps{n_steps}.png'
    )

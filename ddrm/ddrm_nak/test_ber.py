...
from dataset import get_QPSKdataloader, Dataset  
...
if __name__ == "__main__":
    #标签数据
    label = np.load(r'ddrm_qpsk/dataset_isi_normalized\qpsk_labels.npy')  
    ...
    #绘图
     # 绘制并保存BER曲线
    plot_ber_curve(model_bers, baseline_bers, snr_range, save_path='ddrm_qpsk/ber_result/ber_curve_100.png')
